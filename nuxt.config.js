  ...
  head: {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        hid: 'description',
        name: 'description',
        content: "takumma's blog site",
      },
      {
        hid: 'og:site_name',
        property: 'og:site_name',
        content: "takumma's blog",
      },
      { hid: 'og:type', property: 'og:type', content: 'website' },
      {
        hid: 'og:url',
        property: 'og:url',
        content: 'https://blog.takumma.net',
      },
      ...
      },
      {
        ...
        property: 'og:image',
        content:
          'https://res.cloudinary.com/dykntmxnh/image/upload/v1616648526/default_ogp_cunef8.png',
      },
      {
        hid: 'twitter:card',
